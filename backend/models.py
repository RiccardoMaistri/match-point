...
# class TournamentCreate(BaseModel): #TODO:Why?
#     name: str
...
class Tournament(BaseModel):
    ...
    end_date: Optional[datetime] = None #TODO: remove
    due_date: Optional[datetime] = None #TODO: remove
    participants: List[Participant] = []
    teams: List[Team] = []  # For doubles tournaments
    matches: List[Match] = []
    registration_open: bool = True #TODO: just use status
